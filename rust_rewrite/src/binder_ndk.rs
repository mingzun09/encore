...
#[repr(C)] pub struct AIBinder { _private: [u8; 0] }
#[repr(C)] pub struct AIBinder_Class { _private: [u8; 0] }
#[repr(C)] pub struct AParcel { _private: [u8; 0] }
#[repr(C)] pub struct AStatus { _private: [u8; 0] }
...
pub type AIBinder_Class_onTransact = Option<unsafe extern "C" fn(binder: *mut AIBinder, code: transaction_code_t, in_parcel: *const AParcel, out_parcel: *mut AParcel) -> binder_status_t>;
...
unsafe extern "C" {
    ...
    pub fn AIBinder_transact(binder: *mut AIBinder, code: transaction_code_t, in_parcel: *mut *mut AParcel, out_parcel: *mut *mut AParcel, flags: binder_flags_t) -> binder_status_t;
    pub fn AIBinder_prepareTransaction(binder: *mut AIBinder, in_parcel: *mut *mut AParcel) -> binder_status_t;
    pub fn AIBinder_Class_define(interfaceDescriptor: *const c_char, onCreate: AIBinder_Class_onCreate, onDestroy: AIBinder_Class_onDestroy, onTransact: AIBinder_Class_onTransact) -> *mut AIBinder_Class;
    ...
    pub fn AParcel_readString(parcel: *const AParcel, stringData: *mut c_void, allocator: AParcel_stringAllocator) -> binder_status_t;
    pub fn AParcel_writeString(parcel: *mut AParcel, string: *const c_char, length: i32) -> binder_status_t;

    pub fn AParcel_writeInterfaceToken(parcel: *mut AParcel, interface: *const c_char) -> binder_status_t;
